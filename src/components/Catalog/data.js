import Adam65 from "./Filmes/65.jpg"
import ded from "./Filmes/ded.jpg"
import exorcista from "./Filmes/exorcistadopapa.jpg"
import jhonwick from "./Filmes/johnwick4.jpg"
import mario from "./Filmes/mario.jpg"
import panico from "./Filmes/panico6.jpg"
import suzume from "./Filmes/suzume.jpg"
import urso from "./Filmes/ursocracudo.jpg"
...
const Data = [
    ...
    },
    {
        ...
        description: "Mario é um encanador junto com seu irmão Luigi. Um dia, eles vão parar no reino dos cogumelos, governado pela Princesa Peach, "
                    +"mas ameaçado pelo rei dos Koopas, que faz de tudo para conseguir reinar em todos os lugares.",
    ...
    },
    {
        ...
        description: "Sam, Tara, Chad e Mindy, os quatro sobreviventes do massacre realizado pelo Ghostface, decidem deixar Woodsboro para trás em busca "
                    +"de um novo começo em Nova York. Mas não demora muito para eles se tornarem alvo de um novo serial killer.",
    ...
    },
    {
        ...
        description: "Suzume conta a história duma adolescente de 17 anos e a sua jornada através de um Japão devastado por várias calamidades e onde "
                    +"ela terá de fechar as portas que causaram estes desastres.",
    ...
    },
    {
        ...
        description: "Depois de uma operação de contrabando de drogas fracassada, um urso negro ingere uma grande quantidade de cocaína "
                    +"e começa um tumulto movido a drogas.",
